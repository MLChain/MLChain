...
[Tìm kiếm](https://github.com/mlchain/dify/issues?q=is:issue+is:open) một vấn đề hiện có, hoặc [tạo mới](https://github.com/mlchain/dify/issues/new/choose) một vấn đề. Chúng tôi phân loại các vấn đề thành 2 loại:
...
* Nếu bạn muốn chọn một vấn đề từ danh sách hiện có, chỉ cần để lại bình luận dưới vấn đề đó nói rằng bạn sẽ làm.
  ...
  | Yêu cầu tính năng phổ biến từ [bảng phản hồi cộng đồng](https://github.com/mlchain/dify/discussions/categories/feedbacks) của chúng tôi | Ưu tiên trung bình |
...
Nếu bạn đang thêm một nhà cung cấp mô hình, [hướng dẫn này](https://github.com/mlchain/dify/blob/main/api/core/model_runtime/README.md) dành cho bạn.
...
Và thế là xong! Khi PR của bạn được merge, bạn sẽ được giới thiệu là một người đóng góp trong [README](https://github.com/mlchain/dify/blob/main/README.md) của chúng tôi.
