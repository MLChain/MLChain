...
<p align="center">
    ...
    <a href="https://hub.docker.com/u/mlchain" target="_blank">
        <img alt="Tirages Docker" src="https://img.shields.io/docker/pulls/mlchain/dify-web?labelColor=%20%23FDB062&color=%20%23f79009"></a>
    <a href="https://github.com/mlchain/dify/graphs/commit-activity" target="_blank">
        <img alt="Commits le mois dernier" src="https://img.shields.io/github/commit-activity/m/mlchain/dify?labelColor=%20%2332b583&color=%20%2312b76a"></a>
    <a href="https://github.com/mlchain/dify/" target="_blank">
        <img alt="Problèmes fermés" src="https://img.shields.io/github/issues-search?query=repo%3Amlchain%2Fdify%20is%3Aclosed&label=issues%20closed&labelColor=%20%237d89b0&color=%20%235d6b98"></a>
    <a href="https://github.com/mlchain/dify/discussions/" target="_blank">
        <img alt="Messages de discussion" src="https://img.shields.io/github/discussions/mlchain/dify?labelColor=%20%239b8afb&color=%20%237a5af8"></a>
</p>
...
![star-us](https://github.com/mlchain/dify/assets/13230914/b823edc1-6388-4e25-ad45-2f6b187adbb4)
...
Pour ceux qui souhaitent contribuer du code, consultez notre [Guide de contribution](https://github.com/mlchain/dify/blob/main/CONTRIBUTING.md). 
...
> Nous recherchons des contributeurs pour aider à traduire Dify dans des langues autres que le mandarin ou l'anglais. Si vous êtes intéressé à aider, veuillez consulter le [README i18n](https://github.com/mlchain/dify/blob/main/web/i18n/README.md) pour plus d'informations, et laissez-nous un commentaire dans le canal `global-users` de notre [Serveur communautaire Discord](https://discord.gg/8Tpq4AcN9c).
...
* [Discussion GitHub](https://github.com/mlchain/dify/discussions). Meilleur pour: partager des commentaires et poser des questions.
* [Problèmes GitHub](https://github.com/mlchain/dify/issues). Meilleur pour: les bogues que vous rencontrez en utilisant Dify.AI et les propositions de fonctionnalités. Consultez notre [Guide de contribution](https://github.com/mlchain/dify/blob/main/CONTRIBUTING.md).
...
[![Graphique de l'historique des étoiles](https://api.star-history.com/svg?repos=mlchain/dify&type=Date)](https://star-history.com/#mlchain/dify&Date)
