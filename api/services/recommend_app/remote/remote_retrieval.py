...
class RemoteRecommendAppRetrieval(RecommendAppRetrievalBase):
    """
    Retrieval recommended app from mlchain official
    """

    def get_recommend_app_detail(self, app_id: str):
        try:
            result = self.fetch_recommended_app_detail_from_mlchain_official(app_id)
    ...
    def get_recommended_apps_and_categories(self, language: str) -> dict:
        try:
            result = self.fetch_recommended_apps_from_mlchain_official(language)
        except Exception as e:
    ...
    @classmethod
    def fetch_recommended_app_detail_from_mlchain_official(cls, app_id: str) -> Optional[dict]:
        """
    ...
    @classmethod
    def fetch_recommended_apps_from_mlchain_official(cls, language: str) -> dict:
        """
