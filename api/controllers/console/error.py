...
class AlreadySetupError(BaseHTTPException):
    ...
    description = "Mlchain has been successfully installed. Please refresh the page or return to the dashboard homepage."
    code = 403


class NotSetupError(BaseHTTPException):
    error_code = 'not_setup'
    description = "Mlchain has not been initialized and installed yet. " \
