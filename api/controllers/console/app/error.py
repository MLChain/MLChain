...
class ProviderQuotaExceededError(BaseHTTPException):
    ...
    description = "Your quota for Mlchain Hosted Model Provider has been exhausted. " \
...
class ProviderModelCurrentlyNotSupportError(BaseHTTPException):
    ...
    description = "Mlchain Hosted OpenAI trial currently not support the GPT-4 model."
    code = 400
