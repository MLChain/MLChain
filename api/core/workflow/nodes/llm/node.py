...
class LLMNode(BaseNode[LLMNodeData]):
    ...
    def _fetch_model_config(self, node_data_model: ModelConfig) -> tuple[ModelInstance, ModelConfigWithCredentialsEntity]:
        ...
        if provider_model.status == ModelStatus.NO_CONFIGURE:
            ...
            raise ModelCurrentlyNotSupportError(f"Mlchain Hosted OpenAI {model_name} currently not support.")
...
def _calculate_rest_token(*, prompt_messages: list[PromptMessage], model_config: ModelConfigWithCredentialsEntity) -> int:
    rest_tokens = 2000
