    ...
    def init_vector(
        ...
        return OceanBaseVector(
            ...
            OceanBaseVectorConfig(
                host=mlchain_config.OCEANBASE_VECTOR_HOST,
                port=mlchain_config.OCEANBASE_VECTOR_PORT,
                user=mlchain_config.OCEANBASE_VECTOR_USER,
                password=(mlchain_config.OCEANBASE_VECTOR_PASSWORD or ""),
                database=mlchain_config.OCEANBASE_VECTOR_DATABASE,
            ),
        )
