...
class BaiduVectorFactory(AbstractVectorFactory):
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> BaiduVector:
        ...
        return BaiduVector(
            ...
            config=BaiduConfig(
                endpoint=mlchain_config.BAIDU_VECTOR_DB_ENDPOINT,
                connection_timeout_in_mills=mlchain_config.BAIDU_VECTOR_DB_CONNECTION_TIMEOUT_MS,
                account=mlchain_config.BAIDU_VECTOR_DB_ACCOUNT,
                api_key=mlchain_config.BAIDU_VECTOR_DB_API_KEY,
                database=mlchain_config.BAIDU_VECTOR_DB_DATABASE,
                shard=mlchain_config.BAIDU_VECTOR_DB_SHARD,
                replicas=mlchain_config.BAIDU_VECTOR_DB_REPLICAS,
            ),
        )
