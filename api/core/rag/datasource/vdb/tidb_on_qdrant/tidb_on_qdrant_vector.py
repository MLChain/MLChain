    ...
    def init_vector(self, dataset: Dataset, attributes: list, embeddings: Embeddings) -> TidbOnQdrantVector:
        ...
        return TidbOnQdrantVector(
            ...
            config=TidbOnQdrantConfig(
                endpoint=mlchain_config.TIDB_ON_QDRANT_URL,
                api_key=TIDB_ON_QDRANT_API_KEY,
                root_path=config.root_path,
                timeout=mlchain_config.TIDB_ON_QDRANT_CLIENT_TIMEOUT,
                grpc_port=mlchain_config.TIDB_ON_QDRANT_GRPC_PORT,
                prefer_grpc=mlchain_config.TIDB_ON_QDRANT_GRPC_ENABLED,
            ),
        )
