...
export default function AccountPage() {
  ...
  return (
    <>
      ...
      <div className='mb-8'>
        <div className={titleClassName}>{t('common.account.mlChainAccount')}</div>
        <div className={descriptionClassName}>{t('common.account.mlChainAccountTip')}</div>
        {!!apps.length && (
          <Collapse
              ...
              <>
                ...
                <div className='mt-3 text-sm leading-5'>
                  ...
                  <a
                    ...
                    href={`mailto:support@khulnasoft.com?subject=Delete Account Request&body=Delete Account: ${userProfile.email}`}
                    target='_blank'
