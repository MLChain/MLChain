      ...
      >
        <div className='flex items-start self-stretch p-4 pb-0'>
          <div className='flex flex-col items-start gap-1 flex-grow'>
            ...
            <a className='flex justify-center items-center gap-1 self-stretch cursor-pointer' href='https://docs-mlchain.khulnasoft.com/guides/knowledge-base/external-knowledge-api-documentation' target='_blank'>
