            ...
            <div className='text-[#1C64F2]'>
              {
                IS_CE_EDITION
                  ...
                  : <>
                    <Link href='https://mlchain.ai/privacy' target='_blank' rel='noopener noreferrer'>Privacy Policy</Link>,
                    <Link href='https://mlchain.ai/terms' target='_blank' rel='noopener noreferrer'>Terms of Service</Link>
                  </>
              }
            </div>
          </div>
