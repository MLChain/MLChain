  ...
  <Col>
    ...
    <Properties>
      <Property name='message_id' type='str' key='text'>
        For text messages generated by Mlchain, simply pass the generated message-id directly. The backend will use the message-id to look up the corresponding content and synthesize the voice information directly. If both message_id and text are provided simultaneously, the message_id is given priority.
      </Property>
...
<Row>
  ...
  <CodeGroup title="Request" tag="GET" label="/meta" targetCode={`curl -X GET '${props.appDetail.api_base_url}/meta?user=abc-123' \\\n-H 'Authorization: Bearer {api_key}'`}>
    ...
    {
    "tool_icons": {
        "dalle2": "https://cloud-mlchain.khulnasoft.com/console/api/workspaces/current/tool-provider/builtin/dalle/icon",
        "api_tool": {
            "background": "#252525",
            "content": "\ud83d\ude01"
        }
