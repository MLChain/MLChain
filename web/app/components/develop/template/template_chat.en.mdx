...
<Row>
  ...
  <CodeGroup title="Request" tag="GET" label="/meta" targetCode={`curl -X GET '${props.appDetail.api_base_url}/meta?user=abc-123' \\\n-H 'Authorization: Bearer {api_key}'`}>
    ...
    {
    "tool_icons": {
        "dalle2": "https://cloud.mlchain.ai/console/api/workspaces/current/tool-provider/builtin/dalle/icon",
        "api_tool": {
            "background": "#252525",
            "content": "\ud83d\ude01"
        }
