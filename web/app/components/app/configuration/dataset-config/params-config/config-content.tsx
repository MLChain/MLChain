...
const LEGACY_LINK_MAP = {
  en_US: 'https://docs.mlchain.khulnasoft.com/guides/knowledge-base/integrate-knowledge-within-application',
  zh_Hans: 'https://docs.mlchain.khulnasoft.com/v/zh-hans/guides/knowledge-base/integrate_knowledge_within_application',
