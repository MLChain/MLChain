  ...
  >
    <div className='w-full mt-4 px-6 py-5 border-gray-200 rounded-lg border-[0.5px]'>
      ...
      <div className='flex py-4'>
        ...
        <div className='flex flex-col'>
          ...
          <a href={`https://github.com/mlchain/${isChatApp ? 'webapp-conversation' : 'webapp-text-generator'}`} target='_blank' rel='noopener noreferrer'>
      ...
      <div className='flex py-4'>
        ...
        <div className='flex flex-col w-full overflow-hidden'>
          ...
          <pre className='overflow-x-scroll box-border py-3 px-4 bg-gray-100 text-xs font-medium rounded-lg select-text'>
            ...
            NEXT_PUBLIC_APP_KEY={'\'<Web API Key From Mlchain>\''} <br />
    ...
    <div className='w-full mt-4 px-6 py-5 border-gray-200 rounded-lg border-[0.5px]'>
      ...
      <Button
        ...
        onClick={() =>
          window.open(
            `https://docs-mlchain.khulnasoft.com/${locale !== LanguagesSupported[1]
