        ...
        {isShowMore && <>
          ...
          <p className={`mt-1 ${s.settingsTip} text-gray-500`}>
            <Trans
              ...
              components={{ privacyPolicyLink: <Link href={'https://docs-mlchain.khulnasoft.com/user-agreement/privacy-policy'} target='_blank' rel='noopener noreferrer' className='text-primary-600' /> }}
            />
          </p>
          <Input
            className='mt-2 h-10'
