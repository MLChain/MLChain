const translation = {
  ...
  members: {
    ...
    invitationSentTip: '邀請已傳送，對方登入 Mlchain 後即可訪問你的團隊資料。',
    invitationLink: '邀請連結',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      onTrial: '體驗',
      exhausted: '超出限額',
      desc: '託管 OpenAI 由 Mlchain 提供的託管 OpenAI 服務，你可以使用 GPT-3.5 等模型，在體驗額度消耗完畢前你需要設定其它模型供應商。',
      callTimes: '呼叫次數',
  ...
  about: {
    changeLog: '更新日誌',
    updateNow: '現在更新',
    nowAvailable: 'Mlchain {{version}} 現已可用。',
