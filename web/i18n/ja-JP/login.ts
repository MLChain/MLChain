const translation = {
  pageTitle: 'はじめましょう！👋',
  welcome: 'Mlchainへようこそ。続行するにはログインしてください。',
  email: 'メールアドレス',
  ...
  license: {
    tip: 'GitHubのオープンソースライセンスを確認してから、Mlchain Community Editionを開始してください。',
    link: 'オープンソースライセンス',
  },
  join: '参加する',
  ...
  resetPasswordDesc: 'Mlchainへのサインアップに使用したメールアドレスを入力すると、パスワードリセットメールが送信されます。',
  licenseLost: 'ライセンスを失った',
  licenseExpiredTip: 'ワークスペースの Mlchain Enterprise ライセンスの有効期限が切れています。Mlchainを引き続き使用するには、管理者に連絡してください。',
  licenseInactive: 'ライセンスが非アクティブです',
  licenseInactiveTip: 'ワークスペースの Mlchain Enterprise ライセンスが非アクティブです。Mlchainを引き続き使用するには、管理者に連絡してください。',
  licenseExpired: 'ライセンスの有効期限が切れています',
  licenseLostTip: 'Mlchainライセンスサーバーへの接続に失敗しました。続けてMlchainを使用するために管理者に連絡してください。',
}
