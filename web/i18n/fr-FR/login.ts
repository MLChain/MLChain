const translation = {
  ...
  welcome: 'Bienvenue sur Mlchain, veuillez vous connecter pour continuer.',
  ...
  license: {
    tip: 'Avant de commencer Mlchain Community Edition, lisez le GitHub',
    link: 'Licence Open-source',
  },
  join: 'Rejoindre',
  joinTipStart: 'Je vous invite à rejoindre',
  joinTipEnd: 'équipe sur Mlchain',
  invalid: 'Le lien a expiré',
  explore: 'Explorez Mlchain',
  ...
  resetPasswordDesc: 'Tapez l’adresse e-mail que vous avez utilisée pour vous inscrire sur Mlchain et nous vous enverrons un e-mail de réinitialisation de mot de passe.',
  usePassword: 'Utiliser le mot de passe',
  licenseInactiveTip: 'La licence Mlchain Enterprise de votre espace de travail est inactive. Veuillez contacter votre administrateur pour continuer à utiliser Mlchain.',
  licenseLostTip: 'Échec de la connexion au serveur de licences Mlchain. Veuillez contacter votre administrateur pour continuer à utiliser Mlchain.',
  licenseExpired: 'Licence expirée',
  licenseLost: 'Licence perdue',
  licenseExpiredTip: 'La licence Mlchain Enterprise de votre espace de travail a expiré. Veuillez contacter votre administrateur pour continuer à utiliser Mlchain.',
