const translation = {
  ...
  account: {
    ...
    langGeniusAccount: 'Compte Mlchain',
    langGeniusAccountTip: 'Votre compte Mlchain et les données utilisateur associées.',
  ...
  apiBasedExtension: {
    ...
    linkUrl: 'https://docs.mlchain.ai/fonctionnalites/extension/extension_basee_sur_api',
