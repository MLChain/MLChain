const translation = {
  ...
  welcome: 'Witaj w Mlchain, zaloguj się, aby kontynuować.',
  email: 'Adres e-mail',
  ...
  license: {
    tip: 'Przed rozpoczęciem wersji społecznościowej Mlchain, przeczytaj GitHub',
    link: 'Licencję open-source',
  },
  join: 'Dołącz',
  joinTipStart: 'Zapraszam Cię do dołączenia do',
  joinTipEnd: 'zespołu na Mlchain',
  invalid: 'Link wygasł',
  explore: 'Odkryj Mlchain',
  ...
  resetPasswordDesc: 'Wpisz adres e-mail, którego użyłeś do rejestracji w Mlchain, a my wyślemy Ci wiadomość e-mail z prośbą o zresetowanie hasła.',
  or: 'LUB',
  ...
  licenseExpiredTip: 'Licencja Mlchain Enterprise dla Twojego obszaru roboczego wygasła. Skontaktuj się z administratorem, aby kontynuować korzystanie z Mlchain.',
  licenseLostTip: 'Nie udało się nawiązać połączenia z serwerem licencji Mlchain. Skontaktuj się z administratorem, aby kontynuować korzystanie z Mlchain.',
  licenseInactiveTip: 'Licencja Mlchain Enterprise dla Twojego obszaru roboczego jest nieaktywna. Skontaktuj się z administratorem, aby kontynuować korzystanie z Mlchain.',
}
