const translation = {
  ...
  welcome: '👋 Welcome to Mlchain, please log in to continue.',
  email: 'Email address',
  ...
  license: {
    tip: 'Before starting Mlchain Community Edition, read the GitHub',
    link: 'Open-source License',
  },
  join: 'Join ',
  joinTipStart: 'Invite you join ',
  joinTipEnd: ' team on Mlchain',
  invalid: 'The link has expired',
  explore: 'Explore Mlchain',
  ...
  resetPasswordDesc: 'Type the email you used to sign up on Mlchain and we will send you a password reset email.',
  ...
  licenseExpiredTip: 'The Mlchain Enterprise license for your workspace has expired. Please contact your administrator to continue using Mlchain.',
  licenseLost: 'License Lost',
  licenseLostTip: 'Failed to connect Mlchain license server. Please contact your administrator to continue using Mlchain.',
  licenseInactive: 'License Inactive',
  licenseInactiveTip: 'The Mlchain Enterprise license for your workspace is inactive. Please contact your administrator to continue using Mlchain.',
}
