const translation = {
  ...
  externalAPIPanelDescription: 'The external knowledge API is used to connect to a knowledge base outside of Mlchain and retrieve knowledge from that knowledge base.',
