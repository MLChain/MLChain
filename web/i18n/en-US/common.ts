const translation = {
  ...
  account: {
    ...
    mlChainAccount: 'Mlchain account',
    mlChainAccountTip: 'Your Mlchain account and associated user data.',
    editName: 'Edit Name',
  ...
  members: {
    ...
    invitationSentTip: 'Invitation sent, and they can sign in to Mlchain to access your team data.',
  ...
  provider: {
    ...
    openaiHosted: {
      ...
      desc: 'The OpenAI hosting service provided by Mlchain allows you to use models such as GPT-3.5. Before your trial quota is used up, you need to set up other model providers.',
  ...
  apiBasedExtension: {
    title: 'API extensions provide centralized API management, simplifying configuration for easy use across Mlchain\'s applications.',
  ...
  about: {
    ...
    nowAvailable: 'Mlchain {{version}} is now available.',
    latestAvailable: 'Mlchain {{version}} is the latest version available.',
  },
  appMenus: {
    overview: 'Monitoring',
