const translation = {
  ...
  welcome: 'Mlchain\'ye hoş geldiniz, devam etmek için lütfen giriş yapın.',
  ...
  license: {
    tip: 'Mlchain Community Edition\'ı başlatmadan önce GitHub\'daki',
  ...
  resetPasswordDesc: 'Mlchain\'a kaydolmak için kullandığınız e-postayı yazın, size bir şifre sıfırlama e-postası gönderelim.',
  ...
  back: 'Geri',
  licenseExpiredTip: 'Çalışma alanınız için Mlchain Enterprise lisansının süresi doldu. Mlchain\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseLostTip: 'Mlchain lisans sunucusuna bağlanılamadı. Mlchain\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
  licenseInactiveTip: 'Çalışma alanınız için Mlchain Enterprise lisansı etkin değil. Mlchain\'ı kullanmaya devam etmek için lütfen yöneticinizle iletişime geçin.',
