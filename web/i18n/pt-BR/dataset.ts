const translation = {
  ...
  externalAPIPanelDescription: 'A API de conhecimento externo é usada para se conectar a uma base de conhecimento fora do Mlchain e recuperar o conhecimento dessa base de conhecimento.',
