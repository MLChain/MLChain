const translation = {
  ...
  welcome: 'Bem-vindo ao Mlchain, faça login para continuar.',
  ...
  license: {
    tip: 'Antes de começar a usar a Edição Comunitária do Mlchain, leia a',
    link: 'Licença de código aberto do GitHub',
  },
  join: 'Participar',
  joinTipStart: 'Convidamos você a participar da',
  joinTipEnd: 'equipe no Mlchain',
  invalid: 'O link expirou',
  explore: 'Explorar o Mlchain',
  ...
  resetPasswordDesc: 'Digite o e-mail que você usou para se inscrever no Mlchain e enviaremos um e-mail de redefinição de senha.',
  sendVerificationCode: 'Enviar código de verificação',
  usePassword: 'Usar senha',
  licenseInactiveTip: 'A licença do Mlchain Enterprise para seu espaço de trabalho está inativa. Entre em contato com o administrador para continuar usando o Mlchain.',
  licenseLostTip: 'Falha ao conectar o servidor de licenças Mlchain. Entre em contato com o administrador para continuar usando o Mlchain.',
  licenseExpired: 'Licença expirada',
  licenseLost: 'Licença perdida',
  licenseInactive: 'Licença inativa',
  licenseExpiredTip: 'A licença do Mlchain Enterprise para seu espaço de trabalho expirou. Entre em contato com o administrador para continuar usando o Mlchain.',
}
