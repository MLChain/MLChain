const translation = {
  ...
  account: {
    ...
    mlChainAccount: 'Tài khoản Mlchain',
    mlChainAccountTip: 'Tài khoản Mlchain của bạn và dữ liệu người dùng liên quan.',
  ...
  members: {
    ...
    invitationSentTip: 'Lời mời đã được gửi, và họ có thể đăng nhập vào Mlchain để truy cập vào dữ liệu nhóm của bạn.',
  ...
  apiBasedExtension: {
    title: 'Các tiện ích API cung cấp quản lý API tập trung, giúp cấu hình dễ dàng sử dụng trên các ứng dụng của Mlchain.',
  ...
  about: {
    ...
    nowAvailable: 'Mlchain {{version}} hiện đã có sẵn.',
    latestAvailable: 'Mlchain {{version}} là phiên bản mới nhất hiện có.',
  },
  appMenus: {
    overview: 'Giám sát',
