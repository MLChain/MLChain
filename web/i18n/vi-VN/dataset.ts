const translation = {
  ...
  externalAPIPanelDescription: 'API kiến thức bên ngoài được sử dụng để kết nối với cơ sở kiến thức bên ngoài Mlchain và truy xuất kiến thức từ cơ sở kiến thức đó.',
}
