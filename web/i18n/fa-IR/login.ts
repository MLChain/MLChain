const translation = {
  ...
  welcome: 'به Mlchain خوش آمدید، لطفا برای ادامه وارد شوید.',
  email: 'آدرس ایمیل',
  ...
  license: {
    tip: 'قبل از شروع Mlchain Community Edition، GitHub را بخوانید',
    link: 'مجوز منبع باز',
  },
  join: 'عضویت',
  joinTipStart: 'شما را دعوت می‌کنیم به',
  joinTipEnd: 'تیم در Mlchain',
  invalid: 'لینک منقضی شده است',
  explore: 'کاوش Mlchain',
  ...
  resetPasswordDesc: 'ایمیلی را که برای ثبت نام در Mlchain استفاده کرده اید تایپ کنید و ما یک ایمیل بازنشانی رمز عبور برای شما ارسال خواهیم کرد.',
  licenseInactive: 'مجوز غیر فعال',
  licenseLost: 'مجوز گم شده است',
  licenseExpired: 'مجوز منقضی شده است',
  licenseExpiredTip: 'مجوز Mlchain Enterprise برای فضای کاری شما منقضی شده است. لطفا برای ادامه استفاده از Mlchain با سرپرست خود تماس بگیرید.',
  licenseInactiveTip: 'مجوز Mlchain Enterprise برای فضای کاری شما غیرفعال است. لطفا برای ادامه استفاده از Mlchain با سرپرست خود تماس بگیرید.',
  licenseLostTip: 'اتصال سرور مجوز Mlchain انجام نشد. لطفا برای ادامه استفاده از Mlchain با سرپرست خود تماس بگیرید.',
}
