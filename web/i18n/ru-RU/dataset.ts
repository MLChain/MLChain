const translation = {
  ...
  externalAPIPanelDescription: 'Внешний API базы знаний используется для подключения к базе знаний за пределами Mlchain и извлечения знаний из этой базы знаний.',
}
