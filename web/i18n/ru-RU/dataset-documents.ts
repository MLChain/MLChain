const translation = {
  list: {
    title: 'Документы',
    desc: 'Здесь отображаются все файлы базы знаний, и вся база знаний может быть связана с цитатами Mlchain или проиндексирована с помощью чата.',
    ...
    empty: {
      ...
      sync: {
        tip: 'Mlchain будет периодически загружать файлы из вашего Notion и завершать обработку.',
      },
    },
    delete: {
