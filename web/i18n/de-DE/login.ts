const translation = {
  ...
  welcome: 'Willkommen bei Mlchain, bitte melde dich an, um fortzufahren.',
  ...
  license: {
    tip: 'Bevor du mit Mlchain Community Edition beginnst, lies die',
    link: 'Open-Source-Lizenz',
  },
  join: 'Beitreten',
  joinTipStart: 'Lade dich ein, dem',
  joinTipEnd: 'Team auf Mlchain beizutreten',
  invalid: 'Der Link ist abgelaufen',
  explore: 'Mlchain erkunden',
  ...
  resetPasswordDesc: 'Geben Sie die E-Mail-Adresse ein, mit der Sie sich bei Mlchain angemeldet haben, und wir senden Ihnen eine E-Mail zum Zurücksetzen des Passworts.',
  ...
  licenseLostTip: 'Fehler beim Verbinden des Mlchain-Lizenzservers. Wenden Sie sich an Ihren Administrator, um Mlchain weiterhin zu verwenden.',
  licenseInactive: 'Lizenz inaktiv',
  licenseInactiveTip: 'Die Mlchain Enterprise-Lizenz für Ihren Arbeitsbereich ist inaktiv. Wenden Sie sich an Ihren Administrator, um Mlchain weiterhin zu verwenden.',
  licenseExpiredTip: 'Die Mlchain Enterprise-Lizenz für Ihren Arbeitsbereich ist abgelaufen. Wenden Sie sich an Ihren Administrator, um Mlchain weiterhin zu verwenden.',
