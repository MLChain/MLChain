const translation = {
  ...
  welcome: 'Dobrodošli v Mlchain, prosimo, prijavite se za nadaljevanje.',
  ...
  license: {
    tip: 'Preden začnete z Mlchain Community Edition, preberite GitHub',
    link: 'Licenco odprte kode',
  },
  join: 'Pridruži se',
  joinTipStart: 'Vabimo vas, da se pridružite',
  joinTipEnd: 'ekipi na Mlchain',
  invalid: 'Povezava je potekla',
  explore: 'Razišči Mlchain',
  ...
  licenseExpiredTip: 'Licenca za Mlchain Enterprise za vaš delovni prostor je potekla. Če želite še naprej uporabljati Mlchain, se obrnite na skrbnika.',
  usePassword: 'Uporaba gesla',
  sendVerificationCode: 'Pošlji kodo za preverjanje',
  resetPasswordDesc: 'Vnesite e-poštni naslov, ki ste ga uporabili za prijavo na Mlchain, in poslali vam bomo e-poštno sporočilo za ponastavitev gesla.',
  ...
  licenseLostTip: 'Povezava z licenčnim strežnikom Mlchain ni uspela. Če želite še naprej uporabljati Mlchain, se obrnite na skrbnika.',
  licenseInactiveTip: 'Licenca Mlchain Enterprise za vaš delovni prostor je neaktivna. Če želite še naprej uporabljati Mlchain, se obrnite na skrbnika.',
}
