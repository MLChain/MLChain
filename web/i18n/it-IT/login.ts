const translation = {
  ...
  resetPasswordDesc: 'Digita l\'e-mail che hai utilizzato per registrarti su Mlchain e ti invieremo un\'e-mail per reimpostare la password.',
  ...
  licenseLostTip: 'Impossibile connettersi al server licenze Mlchain. Contatta il tuo amministratore per continuare a utilizzare Mlchain.',
  licenseExpired: 'Licenza scaduta',
  licenseLost: 'Licenza persa',
  licenseExpiredTip: 'La licenza Mlchain Enterprise per la tua area di lavoro è scaduta. Contatta il tuo amministratore per continuare a utilizzare Mlchain.',
  licenseInactiveTip: 'La licenza Mlchain Enterprise per la tua area di lavoro è inattiva. Contatta il tuo amministratore per continuare a utilizzare Mlchain.',
