const translation = {
  ...
  welcome: 'Bine ai venit la Mlchain, te rugăm să te autentifici pentru a continua.',
  ...
  or: 'SAU',
  resetPasswordDesc: 'Tastați e-mailul pe care l-ați folosit pentru a vă înscrie pe Mlchain și vă vom trimite un e-mail de resetare a parolei.',
  changePasswordBtn: 'Setați o parolă',
  licenseLostTip: 'Nu s-a reușit conectarea serverului de licențe Mlchain. Contactați administratorul pentru a continua să utilizați Mlchain.',
  licenseInactive: 'Licență inactivă',
  licenseInactiveTip: 'Licența Mlchain Enterprise pentru spațiul de lucru este inactivă. Contactați administratorul pentru a continua să utilizați Mlchain.',
  licenseExpired: 'Licență expirată',
  licenseLost: 'Licență pierdută',
  licenseExpiredTip: 'Licența Mlchain Enterprise pentru spațiul de lucru a expirat. Contactați administratorul pentru a continua să utilizați Mlchain.',
}
