const translation = {
  ...
  apiKeyInfo: {
    ...
    tryCloud: 'Sau încercați versiunea cloud a Mlchain cu cotă gratuită',
  },
  overview: {
    ...
    appInfo: {
      ...
      settings: {
        ...
        more: {
          ...
          privacyPolicyTip: 'Ajută vizitatorii să înțeleagă datele pe care le colectează aplicația, consultați <privacyPolicyLink>Politica de confidențialitate</privacyPolicyLink> a Mlchain.',
      ...
      embedded: {
        ...
        chromePlugin: 'Instalați extensia Chrome Mlchain Chatbot',
        copied: 'Copiat',
        copy: 'Copiați',
      },
      qrcode: {
